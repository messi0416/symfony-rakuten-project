...
use MarketplaceWebService\Model\MarketplaceWebService_Model_CancelFeedSubmissionsRequest;
use MarketplaceWebService\Model\MarketplaceWebService_Model_CancelFeedSubmissionsResponse;
use MarketplaceWebService\Model\MarketplaceWebService_Model_CancelReportRequestsRequest;
use MarketplaceWebService\Model\MarketplaceWebService_Model_CancelReportRequestsResponse;
use MarketplaceWebService\Model\MarketplaceWebService_Model_ErrorResponse;
use MarketplaceWebService\Model\MarketplaceWebService_Model_GetFeedSubmissionCountRequest;
use MarketplaceWebService\Model\MarketplaceWebService_Model_GetFeedSubmissionCountResponse;
use MarketplaceWebService\Model\MarketplaceWebService_Model_GetFeedSubmissionListByNextTokenRequest;
use MarketplaceWebService\Model\MarketplaceWebService_Model_GetFeedSubmissionListByNextTokenResponse;
...
use MarketplaceWebService\Model\MarketplaceWebService_Model_GetReportCountRequest;
use MarketplaceWebService\Model\MarketplaceWebService_Model_GetReportCountResponse;
use MarketplaceWebService\Model\MarketplaceWebService_Model_GetReportListByNextTokenRequest;
use MarketplaceWebService\Model\MarketplaceWebService_Model_GetReportListByNextTokenResponse;
use MarketplaceWebService\Model\MarketplaceWebService_Model_GetReportListRequest;
use MarketplaceWebService\Model\MarketplaceWebService_Model_GetReportListResponse;
use MarketplaceWebService\Model\MarketplaceWebService_Model_GetReportRequest;
use MarketplaceWebService\Model\MarketplaceWebService_Model_GetReportRequestCountRequest;
use MarketplaceWebService\Model\MarketplaceWebService_Model_GetReportRequestCountResponse;
use MarketplaceWebService\Model\MarketplaceWebService_Model_GetReportRequestListByNextTokenRequest;
use MarketplaceWebService\Model\MarketplaceWebService_Model_GetReportRequestListByNextTokenResponse;
...
use MarketplaceWebService\Model\MarketplaceWebService_Model_GetReportScheduleCountRequest;
use MarketplaceWebService\Model\MarketplaceWebService_Model_GetReportScheduleCountResponse;
use MarketplaceWebService\Model\MarketplaceWebService_Model_GetReportScheduleListByNextTokenRequest;
use MarketplaceWebService\Model\MarketplaceWebService_Model_GetReportScheduleListByNextTokenResponse;
use MarketplaceWebService\Model\MarketplaceWebService_Model_GetReportScheduleListRequest;
use MarketplaceWebService\Model\MarketplaceWebService_Model_GetReportScheduleListResponse;
use MarketplaceWebService\Model\MarketplaceWebService_Model_ManageReportScheduleRequest;
use MarketplaceWebService\Model\MarketplaceWebService_Model_ManageReportScheduleResponse;
use MarketplaceWebService\Model\MarketplaceWebService_Model_RequestReportRequest;
use MarketplaceWebService\Model\MarketplaceWebService_Model_RequestReportResponse;
...
use MarketplaceWebService\Model\MarketplaceWebService_Model_UpdateReportAcknowledgementsResponse;
...
class MarketplaceWebService_Client implements MarketplaceWebService_Interface
{
  ...
  private function reportAnyErrors($responseBody, $status, $responseHeaderMetadata)
  {
    ...
    if ($xmlBody !== false) {  // Check XML loaded without errors
      ...
      // 頻発するため、暫定ログ取得処理追加
      $logDir = dirname(dirname(dirname(dirname(dirname(dirname(__FILE__)))))) . '/app/logs/';
      if (file_exists($logDir) && is_dir($logDir) && is_writable($logDir)) {
        $logFile = sprintf('%s/amazon_invoke_error_%s.log', $logDir, (new \DateTime())->format('Ymd'));
        file_put_contents($logFile, sprintf("==(%s)=============================\n", (new \DateTime())->format('Y-m-d H:i:s')), FILE_APPEND);
        file_put_contents($logFile, print_r($exProps, true), FILE_APPEND);
        file_put_contents($logFile, "-------------------------------\n", FILE_APPEND);
        file_put_contents($logFile, print_r($responseBody, true), FILE_APPEND);
        file_put_contents($logFile, "\n\n", FILE_APPEND);
      }
  ...
  private function getDefaultCurlOptions() {
    return array (
      ...
      CURLOPT_STDERR => STDOUT // added by K.Hirai (for logging)
    );
  }
